...
Code for "Contrast-Phys+: Unsupervised and Weakly-supervised Video-based Remote Physiological Measurement via Spatiotemporal Contrast" (TPAMI 2024).

See root [README](../readme.md) for full documentation, evaluation pipeline, results, and pre-trained models.
